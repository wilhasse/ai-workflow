...
2. **terminal-dashboard/** - React SPA with xterm.js terminals that organize tmux-backed sessions. A single header **View ▾** dropdown switches between Terminal, Organizer, and Transcripts (the YouTube transcription view backed by youtube-transcribe-service). The old Grid/overview mode was removed.
